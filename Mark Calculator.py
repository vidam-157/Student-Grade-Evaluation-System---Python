...
print("Progressed Students ", Progressed_Students , histogram(Progressed_Students))
print("Trailored Students ", Trailored_Students , histogram(Trailored_Students))
print("Retriever Students ", Retriever_Students , histogram(Retriever_Students))
print("Excluded Students ", Excluded_Students , histogram(Excluded_Students))
