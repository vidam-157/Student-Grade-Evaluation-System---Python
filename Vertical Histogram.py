...
# Vertical Histogram
counter_list = [Progressed_Students, Trailored_Students, Retriever_Students, Excluded_Students]
height = max(counter_list)

print("Progress", "  Module trailer", "  module retriver", "  Exclude")

for counter in range(0, height):
    if Progressed_Students > 0:
        print("*")
        Progressed_Students = Progressed_Students - 1
    else:
        print("  ", end="")

    if Trailored_Students > 0:
        print("*", end="")
        Trailored_Students = Trailored_Students - 1
    else:
        print("  ", end="")
    if Retriever_Students > 0:
        print("*", end="")
        Retriever_Students = Retriever_Students - 1
    else:
        print("  ", end="")
    if Excluded_Students > 0:
        print("*", end="")
        Excluded_Students = Excluded_Students - 1
    else:
        print("  ", end="")
